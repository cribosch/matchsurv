...
sim.data.MatchCR<-function(nca,
  ...
  if (is.null(cifs)) {
    ecif1<-cbind(c(0,0.2, 0.5, 1:30),
                 c(0,0.054,0.060, 0.110, 0.110, 0.117, 0.126,
                   0.128, 0.125, 0.134, 0.138, 0.140, 0.146,
                   0.156, 0.163, 0.151, 0.151, 0.147, 0.147, 0.147,
                   0.147, 0.147, 0.140, 0.140, 0.140, 0.140,
                   0.140, 0.138, 0.138, 0.138, 0.138, 0.138, 0.138))
    ecif2<-cbind(c(0,0.2,0.5,1:30), c(rep(0,2),rep(0.01,2), 0.02, rep(0.03,11),rep(0.04,17)))
    ucif1<-cbind(0:50,c(0,0.055,0.090,0.12,0.153,0.183,0.230,
                        0.250,0.270,0.290,0.310,0.330,0.350,0.370,
                        0.390,0.410,0.425,0.440,0.455,0.470,0.485,
                        0.500,0.510,0.515,0.522,0.535,0.548,0.560,
                        0.572,0.584,0.597,0.610,0.622,0.634,0.646,
                        0.659,0.669,0.680,0.691,0.711,0.721,0.730,
                        0.739,0.748,0.754,0.760,0.765,0.768,0.772,0.777,0.780))
